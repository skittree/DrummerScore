...
Note: Make sure to download the pre-trained model file `HeartsOnFire-v.1.0.3_nfft1024_89.12.pth` from the models folder in the repository before running the `main.ipynb` notebook.
